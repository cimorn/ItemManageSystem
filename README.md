...
4. 网页预览
   ▸ [网页预览](#网页预览)
5. 运行
   ▸ [使用 Node.js](#使用-node.js) 
   ▸ [使用 VS Code 的 Live Server 扩展](#使用-vs-code的-live-server扩展)
6. 添加自定义数据
    ▸ [添加自定义数据步骤](#添加自定义数据) 
    ▸ [示例](#示例)  
    ▸ [注意事项](#注意事项)
7. 数据格式要求
   ▸ [data/password.json 格式](#data/password.json格式)
   ▸ [data/label.json 格式](#data/label.json格式)
   ▸ [data/item.json 格式](#data/item.json格式)
8. 未来规划
   ▸ [未来想完成的功能](#未来想完成的功能)
9. 源码
   ▸ [源码](#源码) 
